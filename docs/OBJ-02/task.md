...
- [ ] **Task 3: OpenSpec Integration & Governance Configuration**
  - [ ] 3.1 Integrate OpenSpec (`@fission-ai/openspec`) engine CLI configuration and ECC assets within [frameworks/openspec/](file:///d:/dev/agy-os/frameworks/openspec/).
  - [ ] 3.2 Configure governance and workspace rules in [frameworks/openspec/AGENTS.md](file:///d:/dev/agy-os/frameworks/openspec/AGENTS.md) and [.agents/rules/](file:///d:/dev/agy-os/frameworks/openspec/.agents/rules/).
  - [ ] 3.3 **Verification Step**: Verify OpenSpec governance configuration compliance and rule alignment with global PRD invariants.

- [ ] **Task 4: Target Repo Patch Staging & Registry Verification**
  - [ ] 4.1 Verify isolated patch staging directory structure at [frameworks/openspec/harness/patches/](file:///d:/dev/agy-os/frameworks/openspec/harness/patches/) for target repository ([website](file:///d:/CLAUDE-PROJECT/website)) modifications.
  - [ ] 4.2 Implement patch staging guidelines enforcing READ-ONLY access on target repository and staging `.patch`/`.diff` files in harness staging directory.
  - [ ] 4.3 **Verification Step**: Validate patch creation workflow and ensure target repository registry purity without direct target repository modification.

- [ ] **Task 5: Documentation Hierarchy Compliance & Verification Audit**
  - [ ] 5.1 Verify global SSOT PRD compliance at [docs/PRD.md](file:///d:/dev/agy-os/docs/PRD.md) and objective suite layout in [docs/OBJ-02/](file:///d:/dev/agy-os/docs/OBJ-02/).
  - [ ] 5.2 Validate objective suite file purity ensuring [docs/OBJ-02/](file:///d:/dev/agy-os/docs/OBJ-02/) contains strictly [spec.md](file:///d:/dev/agy-os/docs/OBJ-02/spec.md), [design.md](file:///d:/dev/agy-os/docs/OBJ-02/design.md), [task.md](file:///d:/dev/agy-os/docs/OBJ-02/task.md), and [artifacts/](file:///d:/dev/agy-os/docs/OBJ-02/artifacts/).
  - [ ] 5.3 Execute automated verification script using Git Bash (`bash`) to audit forward-slash path formatting (`/`) and clickable `file:///` URIs across all OBJ-02 documentation files.
  - [ ] 5.4 **Verification Step**: Confirm clean execution (exit code 0) across all audit checks and record audit results in [docs/OBJ-02/artifacts/audit-report.md](file:///d:/dev/agy-os/docs/OBJ-02/artifacts/audit-report.md).
